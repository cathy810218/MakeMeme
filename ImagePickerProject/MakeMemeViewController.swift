...
class MakeMemeViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        setUpTextfield(topTextfield, withPlaceholderText: "TOP")
        setUpTextfield(bottomTextfield, withPlaceholderText: "BOTTOM")
        
        if UIImagePickerController.isSourceTypeAvailable(UIImagePickerControllerSourceType.Camera) {
            // only allows the camera button to be enable when there's a camera available
    ...
    func setUpTextfield(textfield: UITextField, withPlaceholderText text: String) {
        ...
        let memeTextfieldAttributes = [
            ...
            NSStrokeWidthAttributeName : -3.0 // positive for stroke, negative for both stroke and fill
        ]
